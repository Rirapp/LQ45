...
def app():
    ...
    st.write('Keakuratan website prediksi ini dihitung dengan MAPE dengan nilai error 15 sampai 45 persen dan disertakan dengan tabel cross validation sebagai tabel pendukung.')
